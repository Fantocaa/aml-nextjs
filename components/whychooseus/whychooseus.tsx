          ...
          <div className="flex items-start gap-4 md:col-span-2">
            <div className="max-w-xl pb-4 flex flex-col items-start">
              ...
              <p className="mt-4 text-gray-500 2xl:text-lg">
                Menyediakan layanan transportasi berkualitas tinggi,
                komprehensif dan selalu memahami kebutuhan cutomer.
              </p>
            </div>
          </div>
          <div className="flex flex-col items-start gap-4 bg-gray-50 p-4 rounded-xl">
            ...
            <div>
              ...
              <p className="mt-2 text-gray-500 text-sm 2xl:text-base">
                Memiliki komitmen untuk memberikan service yang terbaik dan
                loyal terhadap setiap customer yang kami handle.
              </p>
            </div>
          </div>
